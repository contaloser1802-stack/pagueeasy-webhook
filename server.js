...
// É ALTAMENTE RECOMENDADO USAR process.env.UTMIFY_TOKEN AQUI TAMBÉM POR SEGURANÇA!
// Ex: const UTMIFY_TOKEN = process.env.UTMIFY_TOKEN;
...
//   tracking: object // <-- Armazenar os parâmetros de tracking aqui
//   customer: object, // Dados do cliente
//   product: object, // Dados do produto
//   offer: object, // Dados da oferta
//   amountInCents: number // Valor original da transação em centavos
// }
...
                tracking: tracking, // Salva os parâmetros de tracking do frontend
...
                await sendToUTMify(
                    { amountInCents: data.amount }, // <-- CORREÇÃO AQUI: Usa o valor do webhook da BuckPay
